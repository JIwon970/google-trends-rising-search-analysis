...
## Files Included
`Google_Trends_Rising_Search_Dashboard.pdf`

## Notes
- The dashboard is interactive in the PBIX file.
- Images in this folder are static previews only.
- For full interaction, open the PBIX file in /powerbi.
